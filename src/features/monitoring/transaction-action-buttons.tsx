...
export default function TransactionActionButtons({
  ...
  const isMonitoringSelected =
    !showOverview &&
    !showReceivedTransactions &&
    !isShowingExistingTransactions;
  const isReceivedTransactionsSelected =
    !showOverview && showReceivedTransactions && !isShowingExistingTransactions;
  const isOverviewSelected =
    (showOverview || isShowingExistingTransactions) &&
    !showReceivedTransactions &&
  ...
  const {
    ...
    isLoading: isUnconfirmedTransactionsLoading,
    error: unconfirmedTransactionsError,
    isError: isUnconfirmedTransactionsError,
  } = useQueryManyAndWatchChanges<CountResult>(
      ...
      >
        <View className="p-0 rounded-md">
          <View className="relative">
            <Ionicons
              name={
                isReceivedTransactionsSelected
                  ? "notifications"
