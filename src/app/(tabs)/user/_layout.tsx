import { View, Text, Linking, TouchableOpacity, ScrollView, useColorScheme } from 'react-native'
    ...
    >
      ...
      >
        ...
        <View style={{ flex: 1, justifyContent: "flex-end" }}>
          <View
            className={
              (`px-2 py-3 mt-2 ${isDark ? "bg-[#333333]" : "bg-white"}`)
            }
					...
					<Drawer.Screen
						...
						options={{
							...
							drawerIcon: ({ focused }: { focused: boolean }) => {
								const color = focused ? '#008000' : isDark ? colors.white : colors.black
