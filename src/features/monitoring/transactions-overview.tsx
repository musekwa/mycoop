        ...
        {warehouseType === CashewWarehouseType.COOPERATIVE && (
          <View className="border border-gray-300 rounded-md p-1">
            <StockItem
              icon="group"
              label="Agregado"
              value={stockDetails.aggregated}
              color="#166534"
            />
            <StockItem
              icon="cart-arrow-down"
              label="Vendido"
              value={stockDetails.sold}
              color="#1e40af"
            />
            <StockItem
        ...
        {warehouseType === CashewWarehouseType.COOP_UNION && (
          <View className="border border-gray-300 rounded-md p-1">
            <StockItem
              ...
              label="Recebido"
              value={stockDetails.transferredIn}
              color="#166534"
            />
            <StockItem
              icon="cart-arrow-down"
        ...
        {warehouseType === CashewWarehouseType.AGGREGATION && (
          <View className="border border-gray-300 rounded-md p-1">
            ...
            <StockItem
              icon="factory"
              label="Processado"
              value={stockDetails.processed}
              color="#166534"
            />
            <StockItem
              icon="sail-boat"
              label="Exportado"
              value={stockDetails.exported}
              color="#166534"
            />
            <StockItem
              icon="trash-can-outline"
