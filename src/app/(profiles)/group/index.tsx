				...
				<CustomPopUpMenu
					options={[
						...
						},
						{
							...
							icon: <Ionicons name="person-add-outline" color={isDark ? colors.white : colors.black} size={18} />,
							action: () => router.navigate('/(aux)/actors/employees/add-organization-manager' as Href),
						},
					]}
				/>
			),
