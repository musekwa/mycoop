...
export default function Tag({ onPress, title, selected, iconName }: TagProps) {
	return (
		<Pressable
			onPress={onPress}
			className={(`flex flex-row items-center justify-center px-1 py-1 rounded-lg overflow-x-hidden border min-w-[100px] space-x-2 ${selected ? 'border-[#008000] ': 'border-gray-300'}`)}
		>
